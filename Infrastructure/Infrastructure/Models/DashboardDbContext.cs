...
public partial class DashboardDbContext : DbContext
{
    ...
    public virtual DbSet<ApReport> ApReports { get; set; }
    ...
    public virtual DbSet<Onboardingfielddatum> Onboardingfielddata { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=aws-0-us-east-1.pooler.supabase.com;Port=5432 ;Database=postgres;Username=postgres.sgrvspqcrqvxtrahksvv;Password=DaveSahai;SSL Mode=Require");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ApReport>(entity =>
        {
            entity.HasKey(e => e.ApId).HasName("ap_report_pkey");

            entity.ToTable("ap_report");
            ...
            entity.Property(e => e.Hourlywagerate)
                .HasPrecision(10, 2)
                .HasColumnName("hourlywagerate");
            ...
            entity.Property(e => e.Paymentduedate).HasColumnName("paymentduedate");
            entity.Property(e => e.Paymentmode)
                .HasMaxLength(50)
                .HasColumnName("paymentmode");
            entity.Property(e => e.Region).HasColumnName("region");
            entity.Property(e => e.Skilllevel).HasColumnName("skilllevel");
            entity.Property(e => e.Startenddate).HasColumnName("startenddate");
            entity.Property(e => e.Taskordernumber)
                .HasMaxLength(50)
                .HasColumnName("taskordernumber");
            entity.Property(e => e.Timesheetapprovaldate).HasColumnName("timesheetapprovaldate");
        ...
        modelBuilder.Entity<Interview>(entity =>
        {
            ...
            entity.Property(e => e.Candidateselected)
                .HasMaxLength(50)
                .HasColumnName("candidateselected");
            entity.Property(e => e.Clientsuggesteddates).HasColumnName("clientsuggesteddates");
            entity.Property(e => e.Consultantcontactno)
                .HasMaxLength(50)
                .HasColumnName("consultantcontactno");
            entity.Property(e => e.Consultantemail)
                .HasMaxLength(255)
                .HasColumnName("consultantemail");
            entity.Property(e => e.Consultantname)
                .HasMaxLength(255)
                .HasColumnName("consultantname");
            entity.Property(e => e.HbitsNo)
                .HasMaxLength(50)
                .HasColumnName("hbits_no");
            entity.Property(e => e.Interviewconfirmedbyclient).HasColumnName("interviewconfirmedbyclient");
            entity.Property(e => e.Interviewscheduledmailedtomr).HasColumnName("interviewscheduledmailedtomr");
            entity.Property(e => e.Interviewtimeoptedfor).HasColumnName("interviewtimeoptedfor");
            entity.Property(e => e.Level).HasColumnName("level");
            entity.Property(e => e.Maileddatestoconsultant).HasColumnName("maileddatestoconsultant");
            entity.Property(e => e.Mailreceiveddate).HasColumnName("mailreceiveddate");
            entity.Property(e => e.Monthyear)
                .HasMaxLength(7)
                .HasColumnName("monthyear");
            ...
            entity.Property(e => e.Thrurecruiter)
                .HasMaxLength(255)
                .HasColumnName("thrurecruiter");
            entity.Property(e => e.Timeofinterview)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("timeofinterview");
            ...
            entity.Property(e => e.Vendorpocname)
                .HasMaxLength(255)
                .HasColumnName("vendorpocname");
        });
        ...
        {
            entity.HasKey(e => e.Onboardingid).HasName("onboarding_pkey");
        ...
        modelBuilder.Entity<Onboardingfielddatum>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("onboardingfielddata_pkey");

            entity.ToTable("onboardingfielddata");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Detailsvalue).HasColumnName("detailsvalue");
            ...
            entity.HasOne(d => d.Onboarding).WithMany(p => p.Onboardingfielddata)
                .HasForeignKey(d => d.Onboardingid)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("onboardingfielddata_onboardingid_fkey");
        });
        ...
        {
            entity.HasKey(e => e.Taskid).HasName("todo_list_pkey");

            entity.ToTable("todo_list");

            entity.Property(e => e.Taskid).HasColumnName("taskid");
            entity.Property(e => e.Actualduedate).HasColumnName("actualduedate");
            ...
            entity.Property(e => e.Followupneeded).HasColumnName("followupneeded");
            entity.Property(e => e.Internalduedate).HasColumnName("internalduedate");
            entity.Property(e => e.Nextduedate).HasColumnName("nextduedate");
            entity.Property(e => e.Recurring).HasColumnName("recurring");
            entity.Property(e => e.Requiresfiling).HasColumnName("requiresfiling");
            entity.Property(e => e.Status)
                .HasMaxLength(50)
                .HasColumnName("status");
            entity.Property(e => e.Taskname).HasColumnName("taskname");
            entity.Property(e => e.Triggerdate).HasColumnName("triggerdate");
        });
